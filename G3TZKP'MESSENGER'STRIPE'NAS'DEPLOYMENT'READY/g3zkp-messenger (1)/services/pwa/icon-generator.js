 ...
 */
export function generateLogoSVG(size) {
 ...
 */
function generateNodes(count, radius, center) {
    let nodes = '';
 ...
 */
export function generatePaddedIconSVG(size, padding = 0.1) {
 ...
 */
export function generateMaskableIconSVG(size) {
 ...
 */
export function getInlineIcon(size = 200) {
